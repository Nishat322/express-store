...
app.post('/user',(req,res) => {
    //newsletter is not a required value, so we set its value to false as default
    //for objects that do not have a newsletter the value will automatically be set to false
    ...
    //password must contain digit, using a regex here
    ...
    const clubs = [
        ...
        'Utah Olumpics Oval Curling Club'
    ];
    ...
    res.send('All validtions passed');
